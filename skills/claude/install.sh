...
# nas fontes canónicas (server/pipeline/prompts + skills/shared/scripts). Não-op se já estiver alinhado.
...
echo "  3. (Optional) Set PAGECRAFT_VAULT if your pedagogical vault is not at ~/vault."
