...
- `outputs/lessons/fracoes-minecraft-isolated-e2e-v2-design-brief.md`: síntese curta de intenção visual, hierarquia, ritmo e adequação ao 2.º ano.
- `outputs/lessons/fracoes-minecraft-isolated-e2e-v2-design-spec.json`: JSON object que mencione explicitamente acessibilidade, contraste, responsive/tablet/mobile, cores, tipografia, estados de feedback e layout.
