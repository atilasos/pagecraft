...
- `outputs/lessons/fracoes-minecraft-isolated-e2e-v2-builder-clarification-v1.md`
- `outputs/lessons/fracoes-minecraft-isolated-e2e-v2-repair-ticket-v1.json`
- `outputs/lessons/fracoes-minecraft-isolated-e2e-v2-proofread-v1.json`

## Inputs proibidos
- `outputs/lessons/fracoes-minecraft-isolated-e2e-v2.html` existente, se existir.
